  ...
  <div class="bg-surface-100 dark:bg-surface-900 flex items-center justify-center min-h-screen p-10">
    ...
    >
      ...
      <Panel
        ...
        :pt="{
          header:
            'flex items-center justify-center p-5 bg-gradient-to-r from-rose-400 via-fuchsia-500 to-red-500 rounded-tl-2xl rounded-tr-2xl text-white',
          title: 'leading-none font-bold uppercase text-2xl',
          content:
            'bg-gradient-to-r from-rose-400 via-fuchsia-500 to-yellow-500 px-5 pb-8 pt-3 text-white text-center rounded-bl-2xl rounded-br-2xl text-xl',
        }"
      >
        <p>
